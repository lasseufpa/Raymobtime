...
#Inputs
numEpisodes = range(0,6,1) #interator that determines number of episodes to be read
raymobtimepath = './insite_data_s004_carrier60GHz' #Insert the location of the files to be read
